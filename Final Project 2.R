...
data <- read_excel("C:/Users/junji/OneDrive/Desktop/Marquette Subjects/COSC 6520/Monthly Gas Price.xlsx")
head(data)

##use ts to create a time series object; specify start and end; freq is number of seasons
newData <- ts(data$`Gas Price`, start = c(2013,1), end = c(2022,12), frequency=12)
